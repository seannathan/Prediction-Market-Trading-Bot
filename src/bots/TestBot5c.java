 ...
 * Sells at a 
 */
public class TestBot5c extends AbsPredictionMarketAgent {
	...
	public TestBot5c(String host, int port, String name) throws AgentCreationException {
	...
	public void onMarketRequest(CallMarketChannel channel) {		
		if (stage == 0) {
			...
			if (!stage0Selling) {
				cancel(sellValue, true, channel);
				buyValue += stepSize;
				buy(buyValue, 1, channel);
			} else {
				// Cancels and makes new sell.
				cancel(buyValue, false, channel);
				sellValue -= stepSize;		
				sell(sellValue, 1, channel);
			}
			stage0Selling = !stage0Selling;
	...
	public static void main(String[] args) throws AgentCreationException {
		new TestBot5c("localhost", 2121, "bot4");
